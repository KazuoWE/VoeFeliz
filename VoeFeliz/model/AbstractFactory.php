 ...
 * @author Wandermar Marques Ferreira - Acadêmico TADS (melhoria na conexão com o banco, mostrando as mensagens de erro retornadas pelo banco) 
...
abstract class AbstractFactory {
    ...
    public function __construct() {
        ...
        try {
            $this->db = new PDO("sqlite:model/VoeFeliz.sqlite");
